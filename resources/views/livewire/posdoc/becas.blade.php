<div class="px-6">
    @if($editMode)
    <h3 class="font-bold text-lg border-b mt-2 text-slate-500">Becas</h3>
    <form>
        <div class="grid grid-cols-4 gap-2 mt-2">
            <div class="form-floating">
                <input type="text"
                    ...
                    placeholder="Beca posdoctoral" wire:model="beca_id">
                <label class="text-gray-700">Beca posdoctoral</label>
            </div>
            <div class="form-floating">
                <input type="date"
                    class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-bl focus:outline-none"
                    placeholder="Vigencia (inicia)" wire:model="fecha_inicio">
                <label class="text-gray-700">Vigencia (inicia)</label>
            </div>
            <div class="form-floating">
                <input type="date"
                    class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-bl focus:outline-none"
                    placeholder="Vigencia (finaliza)" wire:model="fecha_fin">
                <label class="text-gray-700">Vigencia (finaliza)</label>
            </div>
            <div class="flex items-end">
                <button wire:click.prevent="storeBecaPos()" type="button"
